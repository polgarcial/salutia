<?php
/**
 * API para obtener las citas pendientes de un médico
 * Este script devuelve todas las citas pendientes para un médico específico
 */
...
debug_log('ID del médico recibido', ['doctor_id' => $doctor_id]);
...
try {
    ...
    debug_log('Conexión a la base de datos establecida para obtener citas pendientes');
    ...
    debug_log('Error al obtener citas pendientes', ['error' => $e->getMessage()]);
    http_response_code(500);
    echo json_encode(['success' => false, 'message' => 'Error al obtener citas pendientes: ' . $e->getMessage()]);
}
