...
try {
    ...
    // Construir consulta SQL para obtener citas pendientes (excluyendo explícitamente las rechazadas)
    $sql = "
        ...
        AND a.id NOT IN (SELECT id FROM appointments WHERE status = 'rejected')
    ...
    error_log('Error en get_pending_appointments.php: ' . $e->getMessage());
